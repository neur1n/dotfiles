...
local fonts = {
  ...
  {["name"] = "IntoneMono NFM"                , ["size"] = 11},
  {["name"] = "JetBrainsMono NFM"             , ["size"] = 11},
  {["name"] = "Maple Mono NF"                 , ["size"] = 11},
  {["name"] = "MonaspiceAr NFM"               , ["size"] = 11},
  {["name"] = "MonaspiceKr NFM"               , ["size"] = 11},
  {["name"] = "MonaspiceNe NFM"               , ["size"] = 11},
  {["name"] = "MonaspiceRn NFM"               , ["size"] = 11},
  {["name"] = "MonaspiceXe NFM"               , ["size"] = 11},
