...
function! neur1n#lintinfo#ErrorCount() abort
    let l:bufnr = bufnr('%')
...
function! neur1n#lintinfo#WarnCount() abort
    let l:bufnr = bufnr('%')
    let l:loclist = getloclist(0)
...
function! neur1n#lintinfo#Jump(direction, wrap) abort
...
function! neur1n#lintinfo#Count() abort
    let l:bufnr = bufnr('%')
    let l:loclist = getloclist(0)
