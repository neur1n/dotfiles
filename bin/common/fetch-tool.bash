...
usage() {
  ...
  printf 'Targets: bottom deja-vu fd fzf neovim nushell opencode ripgrep tree-sitter zellij zoxide\n'
}
...
TARGET="$1"
case "$TARGET" in
  bottom|deja-vu|fd|fzf|neovim|nushell|opencode|ripgrep|tree-sitter|zellij|zoxide)
    ;;
  *)
